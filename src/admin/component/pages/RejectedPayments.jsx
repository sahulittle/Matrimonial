...
const RejectedPayments = () => {
    ...
    // Mock data for rejected payments - empty list as requested
    const payments = [];
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h4 className="text-2xl font-bold text-gray-800">Rejected Payments</h4>
                        ...
                        {currentPayments.length > 0 ? currentPayments.map((payment) => {
                            ...
                            return (
                                <tr key={payment.id} className="border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4 text-center"><span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-xs font-semibold">{payment.status}</span></td>
