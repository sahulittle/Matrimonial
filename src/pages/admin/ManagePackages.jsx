...
import { getAllPackages, togglePackageStatus, createPackage, } from "../../api/adminApi/adminApi";
          ...
          <tbody className="text-gray-700">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <td className="py-3 px-4">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-semibold ${pkg.status === "Active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                  >
                    {pkg.status}
                  </span>
                </td>
