...
const InitiatedPayments = () => {
    ...
    // Mock data for 1 initiated payment
    const payments = Array.from({ length: 1 }, (_, i) => {
        const userName = names[i];
        const userUsername = userName.toLowerCase().replace(/\s/g, '');
        const initiatedDate = new Date(Date.now() - i * 1000 * 60 * 60 * 24 * (Math.random() * 10 + 1)); // Randomly in the last few months
        ...
        return {
            ...
            details: {
                ...
                'Amount': `₹${amount.toFixed(2)}`,
                'Payable': `₹${(amount * 1.02).toFixed(2)}`, // Example with a fee
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h4 className="text-2xl font-bold text-gray-800">Initiated Payments</h4>
                ...
                <table className="min-w-full bg-white">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="py-3 px-4 text-left text-sm font-semibold text-gray-600 uppercase">Conversion</th>
                        ...
                        {currentPayments.map((payment) => {
                            ...
                            return (
                                <tr key={payment.id} className="border-b border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4 text-center"><span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-semibold">{payment.status}</span></td>
