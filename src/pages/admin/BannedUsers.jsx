...
const BannedUsers = () => {
    ...
    const users = [
        { id: 4, firstName: 'Banned', lastName: 'User 1', username: 'banned1', email: 'banned1@example.com', mobile: '111-222-3333', country: 'USA', joined: '2022-12-01', avatar: 'https://i.pravatar.cc/150?u=banned1' },
        { id: 5, firstName: 'Banned', lastName: 'User 2', username: 'banned2', email: 'banned2@example.com', mobile: '444-555-6666', country: 'Germany', joined: '2023-01-01', avatar: 'https://i.pravatar.cc/150?u=banned2' },
    ];
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h4 className="text-2xl font-bold text-gray-800">Banned Users</h4>
