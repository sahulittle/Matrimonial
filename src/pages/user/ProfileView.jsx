...
const ProfileView = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      if (targetProfile) {
        ...
        setIsInterestSent(
          sent.some((i) => String(i.receiverId) === String(id)),
        );
      }
    }
  }, [id]);
  ...
  const details = [
    ...
    },
    {
      icon: GraduationCap,
      label: "Qualification",
      value: profile.education?.qualification || "Not specified",
    },
    {
      icon: Users,
      label: "Family Type",
      value: profile.family?.familyType || "Not specified",
    },
  ];
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <p className="font-medium text-gray-900">
                  {profile.education?.qualification || "Not specified"}
                </p>
              </div>
              ...
              <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <p className="font-medium text-gray-900">
                  {profile.education?.company || "Not specified"}
                </p>
              </div>
              ...
              <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <p className="font-medium text-gray-900">
                  {profile.education?.income || "Not specified"}
                </p>
              </div>
            </div>
          </div>
