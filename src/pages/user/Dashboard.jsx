        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <Link to="/user/interests" className="text-sm font-medium text-pink-600 hover:text-pink-700">
                View All
              </Link>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <Link to="/user/visitors" className="text-sm font-medium text-pink-600 hover:text-pink-700">
                View All
              </Link>
