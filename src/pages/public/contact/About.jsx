...
import { getAboutPage } from "../../../api/userApi/userApi";
...
const About = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero: full bleed with overlay */}
      <header
        className="w-full bg-cover bg-top md:bg-center bg-no-repeat 
             h-[220px] sm:h-[280px] md:h-[400px] lg:h-[500px] 
             flex items-center justify-center"
        style={{ backgroundImage: `url(${aboutData.heroImage})` }}
      >
        <div className="w-full h-full bg-gradient-to-r from-black/60 via-black/40 to-black/60 flex items-center justify-center px-6">
