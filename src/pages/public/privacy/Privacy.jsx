    ...
    <>
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 mt-12">
        ...
        <p className="mb-6 text-gray-700 leading-relaxed text-justify">
          Welcome to <strong>MarathiShubhavivah</strong>. We value your trust
          ...
          using our platform, you agree to the terms outlined in this Privacy
          Policy.
        </p>
        ...
        <p className="text-gray-700">
          Your profile may be visible to other registered users. Information
          like name, age, location, and preferences may be displayed. You can
          control visibility from your account settings.
        </p>
        ...
        <p className="text-gray-700">
          We use secure systems and restricted access to protect your data, but
        ...
        <p className="text-gray-700">
          You can delete your account anytime. Some data may be retained for
        ...
        <p className="text-gray-700">
          Fake profiles, scams, or misuse are strictly prohibited. Accounts may
          be suspended.
        </p>
