  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 mt-10">
      ...
      <p className="mb-6 text-gray-700 leading-relaxed text-justify">
        This Purchase Policy outlines the terms related to payments, subscriptions,
        cancellations, and refunds for services offered by{" "}
        <strong>MarathiShubhavivah</strong>. By purchasing any paid service on our platform,
      ...
      {/* 2 */}
      <h2 className="text-2xl font-semibold mt-6 mb-3">2. Pricing & Payments</h2>
      <ul className="list-disc pl-6 text-gray-700 space-y-1">
        <li>All prices are displayed on the website and may change anytime</li>
        <li>Payments must be made through approved methods on the platform</li>
        <li>Users must provide accurate payment information</li>
      </ul>

      {/* 3 */}
      <h2 className="text-2xl font-semibold mt-6 mb-3">3. No Guarantee of Matches</h2>
      <p className="text-gray-700">
        Purchasing a plan does not guarantee matches, responses, or marriage outcomes.
        Paid services only improve visibility and access to platform features.
      </p>
      ...
      <p className="text-gray-700 font-medium mt-3">Exceptions (if applicable):</p>
      <ul className="list-disc pl-6 text-gray-700 space-y-1">
        <li>Payment deducted but service not activated</li>
        <li>Duplicate transactions</li>
      </ul>
      <p className="text-gray-700 mt-2">
        Refund requests must be made within <strong>7 days</strong> of the transaction.
      </p>

      {/* 5 */}
      <h2 className="text-2xl font-semibold mt-6 mb-3">5. Cancellation Policy</h2>
      <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      {/* 6 */}
      <h2 className="text-2xl font-semibold mt-6 mb-3">6. Subscription Validity</h2>
      <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      {/* 7 */}
      <h2 className="text-2xl font-semibold mt-6 mb-3">7. Account Suspension Impact</h2>
      <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      <p className="text-gray-700">
        For failed transactions, delayed activation, or payment errors,
        users should contact support with transaction details.
      </p>

      {/* 9 */}
      <h2 className="text-2xl font-semibold mt-6 mb-3">9. Changes to Pricing & Plans</h2>
      <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      <p className="text-gray-700">
        Fraudulent payments or misuse may result in account suspension and legal action if required.
      </p>
