...
import { initializeDemoData } from './afterlogin/utils/demoSeeder';
...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Navigate to dashboard. Other components will need to be updated
    // to read user and profile information from localStorage instead of Redux.
    navigate('/afterlogin/dashboard');
  };
