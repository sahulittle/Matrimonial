...
const Navbar = ({ toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    { path: "/user/matches", label: "Matches", icon: Users, badge: recommendationsCount },
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                {showUserMenu && (
                  ...
                  >
                    ...
                    <DropdownItem to="/user/profile" label="My Profile" icon={User} />
                    <DropdownItem to="/user/settings" label="Settings" icon={Settings} />
